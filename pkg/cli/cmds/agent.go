...
var (
	...
	PrivateRegistryFlag = cli.StringFlag{
		...
		Value:       "/data/data/com.termux/files/usr/etc/rancher/" + version.Program + "/registries.yaml",
	}
	...
	ImageCredProvBinDirFlag = cli.StringFlag{
		...
		Value:       "/data/data/com.termux/files/usr/var/lib/rancher/credentialprovider/bin",
	}
	ImageCredProvConfigFlag = cli.StringFlag{
		...
		Value:       "/data/data/com.termux/files/usr/var/lib/rancher/credentialprovider/config.yaml",
	}
	...
	return cli.Command{
		...
		Flags: []cli.Flag{
			...
			cli.StringFlag{
				...
				Value:       "/data/data/com.termux/files/usr/var/lib/rancher/" + version.Program + "",
			},
			NodeNameFlag,
			WithNodeIDFlag,
			NodeLabels,
